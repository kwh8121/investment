...
**상태:** 완료 (Completed) — DG1 미승인(Task 003 별도 진행 필요), Task 003 착수 전
**의존성:** Task 001  
**완료 Gate:** DG1 일부
...
**Task 001과 Task 002가 완료되었으므로 다음 행동은 Task 003 — 데이터·권한·품질 Gate(DG1) 확정이다.**
